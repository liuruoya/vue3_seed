	...
	<div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
		<el-dropdown :show-timeout="70" :hide-timeout="50" trigger="click">
			<div class="layout-navbars-breadcrumb-user-icon">
				<i class="fa fa-hand-o-right" :title="$t('message.user.title')" id="title0" @click.prevent.stop="handleGuide"></i>
			</div>
		</el-dropdown>
		...
		<div class="layout-navbars-breadcrumb-user-icon" @click="onLayoutSetingClick">
			<i class="icon-skin iconfont" :title="$t('message.user.title3')" id="title1"></i>
		</div>
		<!-- <div class="layout-navbars-breadcrumb-user-icon">
...
import { steps } from '/@/layout/driver/step';
